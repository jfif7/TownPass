        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm opacity-90">Mission Details</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between text-sm mb-2">
            ...
            <span className="text-muted-foreground">
              {completedPoints}/{totalPoints} checkpoints
            </span>
          </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {!point.completed && (
                      <Button asChild size="sm" className="w-full sm:w-auto">
                        <Link href={`/navigate/${point.id}`}>Navigate Here</Link>
                      </Button>
                    )}
                  </div>
                </div>
        ...
        {progress === 100 && (
          <Card className="bg-primary text-primary-foreground">
            <CardContent className="p-6 text-center">
              ...
              <p className="mb-4 opacity-90">You've completed all checkpoints</p>
              <Button asChild variant="secondary" size="lg" className="w-full sm:w-auto">
                <Link href={`/complete/${mission.id}`}>Claim Your Badge</Link>
              </Button>
            </CardContent>
          </Card>
        )}
